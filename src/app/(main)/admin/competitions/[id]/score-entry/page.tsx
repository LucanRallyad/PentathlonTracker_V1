...
const cellAthleteName =
  "border border-[#D5D5D2] bg-[#FAFAF8] px-3 py-2 text-sm text-[#37352F] sticky left-[40px] z-10 min-w-[120px]";
const cellComputed =
                      ...
                      return (
                        <tr key={athleteId}>
                          ...
                          <td className={cellAthleteName}>
                            ...
                            <span className="md:hidden font-semibold">{athlete.firstName[0]}{athlete.lastName[0]}</span>
                          </td>
        ...
        <table ref={gridRef} onKeyDown={handleKeyDown} className="w-full border-collapse">
          <thead>
            <tr>
              ...
              <th className={`${cellHeader} text-left sticky left-[40px] z-30 min-w-[120px]`}>Athlete</th>
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 mb-3">
        <div className="inline-flex rounded-[4px] border border-[#E9E9E7] overflow-hidden">
          <button
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium transition-colors border-l border-[#E9E9E7] ${
              mode === "manual"
                ? "bg-[#37352F] text-white"
                : "bg-white text-[#787774] hover:bg-[#F7F6F3] hover:text-[#37352F]"
            }`}
        ...
        <span className="text-[10px] text-[#9B9A97]">
          {mode === "bracket"
            ? "Auto-generate bracket from ranking round and enter match results"
            : "Manually enter final placement numbers"}
        </span>
      </div>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleGenerate}
            disabled={generating}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#787774] border border-[#E9E9E7] rounded-[4px] hover:bg-white transition-colors disabled:opacity-50"
          >
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-[#37352F] rounded-[4px] hover:bg-[#2F2E2B] transition-colors disabled:opacity-50"
          >
            <Save size={12} />
          ...
          <button
            onClick={handlePrint}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#787774] border border-[#E9E9E7] rounded-[4px] hover:bg-white transition-colors"
          >
            <Printer size={12} />
            Print
          </button>
          <button
            ...
            disabled={saving}
            className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-[4px] transition-colors disabled:opacity-50 ${
              seeding?.published
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#6940A5] border border-[#D5D0E5] rounded-[4px] hover:bg-[#F5F0FA] transition-colors"
          >
            <ListOrdered size={12} />
            Print Start List
          </button>
