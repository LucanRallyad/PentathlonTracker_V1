      ...
      <div className="flex gap-0.5 overflow-x-auto scrollbar-hide">
        {tabs.map((tab) => (
          <button
            ...
            className={cn(
              "px-3 md:px-4 py-2.5 text-xs md:text-sm font-medium transition-all duration-200 rounded-t-[calc(var(--radius)-2px)] relative whitespace-nowrap md:flex-1 text-center flex-shrink-0",
