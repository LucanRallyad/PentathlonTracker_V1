      ...
      <div className="flex flex-col gap-2 mb-3">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-3 py-2.5 md:py-1.5 text-sm md:text-xs font-medium text-[#E03E3E] border border-[#F0C8C8] rounded-[4px] hover:bg-[#FEF2F2] transition-colors disabled:opacity-50"
          >
            {isResetting ? (
...
<body>
  ...
  return (
    <button
      onClick={handlePrint}
      className="flex items-center justify-center gap-1.5 px-3 py-2.5 md:py-1.5 text-sm md:text-xs font-medium text-[#787774] border border-[#E9E9E7] rounded-[4px] hover:bg-[#F7F6F3] hover:text-[#37352F] transition-colors"
    >
      <Printer size={12} />
      Print Bracket
    </button>
