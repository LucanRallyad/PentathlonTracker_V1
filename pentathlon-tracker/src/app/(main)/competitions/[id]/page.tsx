...
function AthleteName({ firstName, lastName }: { firstName: string; lastName: string }) {
  return (
    <>
      <span className="hidden md:inline">{firstName} {lastName}</span>
      <span className="md:hidden">{firstName} {lastName?.charAt(0) ? `${lastName.charAt(0)}.` : ""}</span>
    </>
  );
}
            ...
            {athletes.map(({ athleteId, athlete }, idx) => {
              ...
              return (
                <tr key={athleteId}>
                  ...
                  <td className={cellAthleteName}><AthleteName firstName={athlete.firstName} lastName={athlete.lastName} /></td>
                    ...
                    <tbody>
                      {heat.assignments.map((a) => (
                        <tr key={a.athleteId}>
                          ...
                          <td className={cellReadonlyStyle}><AthleteName firstName={a.firstName} lastName={a.lastName} /></td>
